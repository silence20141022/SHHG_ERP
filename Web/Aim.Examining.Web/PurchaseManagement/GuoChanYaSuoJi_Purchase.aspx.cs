...
{
    public partial class GuoChanYaSuoJi_Purchase : System.Web.UI.Page
    {
        int totalProperty = 0;
        string sql = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (action)
            {
                ...
                case "loadproduct":
                    ...
                    sql = @"select a.Id as ProductId,Name,Code,Pcn as PCN,SalePrice as BuyPrice,
                         (select isnull(sum(StockQuantity),0) from SHHG_AimExamine..StockInfo where ProductId=a.Id ) as StockQuantity 
                ...
                case "create":
                    ...
                    poEnt.GoodsResource = "GCYSJ";
                    poEnt.ProductType = "压缩机";
