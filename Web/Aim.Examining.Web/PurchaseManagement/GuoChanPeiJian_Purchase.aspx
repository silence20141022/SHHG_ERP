<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuoChanPeiJian_Purchase.aspx.cs"
    Inherits="Aim.Examining.Web.PurchaseManagement.GuoChanPeiJian_Purchase" %>
    ...
    <script type="text/javascript">
            ...
            var toolbar = Ext.create("Ext.toolbar.Toolbar", {
                items: [
                   ...
                   { text: "添加", icon: '/images/shared/add.png', handler: function () {
                       opencenterwin('GuoChanPeiJian_Purchase_Edit.aspx', 800, 550);
                   }
                   },
                   { text: "修改", icon: '/images/shared/edit.gif', handler: function () {
                       ...
                       opencenterwin('GuoChanPeiJian_Purchase_Edit.aspx?id=' + recs[0].get("Id"), 800, 550);
                   }
                   },
                   { text: '删除', icon: '/images/shared/delete.gif', handler: function () {
                       ...
                       Ext.Ajax.request({
                           url: 'GuoChanPeiJian_Purchase.aspx?action=delete&id=' + recs[0].get("Id"),
        ...
        function displayInnerGrid(div) {
            var store_inner = Ext.create('Ext.data.JsonStore', {
                ...
                proxy: {
                    url: 'GuoChanPeiJian_Purchase.aspx?action=loaddetail&id=' + div,
                    type: 'ajax',
                    reader: {
                        type: 'json',
                        root: 'innerrows'
