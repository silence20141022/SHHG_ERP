<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QiTaChanPin_Purchase.aspx.cs"
    Inherits="Aim.Examining.Web.PurchaseManagement.QiTaChanPin_Purchase" %>
    ...
    <script type="text/javascript">
        ...
        Ext.onReady(function () {
            ...
            store = Ext.create('Ext.data.JsonStore', {
                ...
                proxy: {
                    url: 'QiTaChanPin_Purchase.aspx?action=load',
                    type: 'ajax',
                    reader: {
                        type: 'json',
                        root: 'rows',
            ...
            var toolbar = Ext.create("Ext.toolbar.Toolbar", {
                items: [
                   ...
                   { text: "添加", icon: '/images/shared/add.png', handler: function () {
                       opencenterwin('QiTaChanPin_Purchase_Edit.aspx', 800, 550);
                   }
                   },
                   { text: "修改", icon: '/images/shared/edit.gif', handler: function () {
                       ...
                       opencenterwin('QiTaChanPin_Purchase_Edit.aspx?id=' + recs[0].get("Id"), 800, 550);
                   }
                   },
            ...
            var grid = Ext.create('Ext.grid.Panel', {
                ...
                listeners: { cellclick: function (tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
                    if (cellIndex == 3) {
                        opencenterwin('QiTaChanPin_Purchase_Edit.aspx?op=v&id=' + record.get("Id"), 800, 550);
                    }
                }
                }
            })
        ...
        function displayInnerGrid(div) {
            if (!Ext.getCmp('grid_' + div)) {//如果该innergrid不存在
                ...
                Ext.getCmp('grid_' + div).store.load();
            }
        }
