<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="PurchaseBillTab.aspx.cs" Inherits="Aim.Examining.Web.PurchaseManagement.PurchaseBillTab" %>
        ...
        function setPgUI() {
            ...
            var viewport = new Ext.ux.AimViewport({
                ...
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "PurchaseOrderList.aspx?Index=0";
                }
            }
            function handleActivate(tab) {
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "PurchaseOrderList.aspx?Index=" + tabpanel.activeTab.tooltip;
                }
            }
    </script>
