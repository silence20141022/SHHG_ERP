<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuoChanYaSuoJi_Purchase_Edit.aspx.cs"
    Inherits="Aim.Examining.Web.PurchaseManagement.GuoChanYaSuoJi_Purchase_Edit" %>
    ...
    <script type="text/javascript">
        ...
        Ext.onReady(function () {
            var store_supplier = Ext.create('Ext.data.JsonStore', {
                ...
                proxy: {
                    url: 'GuoChanYaSuoJi_Purchase.aspx?action=loadsupplier',
                    type: 'ajax',
                    reader: {
                        root: 'rows',
                        type: 'json'
            ...
            var formPanel = Ext.create("Ext.form.Panel", {
                ...
                { text: "保 存", hidden: getQueryString('op') == 'v', handler: function () {
                    if (formPanel.getForm().isValid()) {
                        ...
                        Ext.Ajax.request({
                            url: 'GuoChanYaSuoJi_Purchase.aspx',
            ...
            if (id) {
                Ext.Ajax.request({
                    url: 'GuoChanYaSuoJi_Purchase.aspx?action=loadform&id=' + id,
                    success: function (response, opts) {
        ...
        function ini_win_purchaseproductselect(supplierid) {
            var store_product = Ext.create('Ext.data.JsonStore', {
                ...
                model: 'Product',
                proxy: {
                    url: 'GuoChanYaSuoJi_Purchase.aspx?action=loadproduct',
                    type: 'ajax',
                    reader: {
                        type: 'json',
                        root: 'rows'
