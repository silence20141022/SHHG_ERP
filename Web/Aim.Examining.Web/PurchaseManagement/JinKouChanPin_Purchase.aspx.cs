...
{
    public partial class JinKouChanPin_Purchase : System.Web.UI.Page
    {
        int totalProperty = 0;
        string sql = "";
            ...
            switch (action)
            {
                case "load":
                    ...
                    sql = @"select *,(select sum(b.RuKuDanQuan) from SHHG_AimExamine..PurchaseOrderDetail b where b.PurchaseOrderId=PurchaseOrder.Id) as RuKuDanQuan,
                          ...
                          from SHHG_AimExamine..PurchaseOrder where GoodsResource='JKCP' " + where;
