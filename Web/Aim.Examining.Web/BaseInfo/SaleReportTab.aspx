<%@ Page Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="SaleReportTab.aspx.cs" Inherits="Aim.Examining.Web.BaseInfo.SaleReportTab" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadHolder" runat="server">

    <script type="text/javascript">
        var tabs, tabpanel, tabarray, viewport;
        function onPgLoad() {
            setPgUI();
        }
        function setPgUI() {
            ...
            viewport = new Ext.ux.AimViewport({
                ...
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "SaleReportLeft.aspx?Index=0";
                }
            }
            function handleActivate(tab) {
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "SaleReportLeft.aspx?Index=" + tabpanel.activeTab.tooltip;
                }
            }
    </script>
