<%@ Page Title="销售收款记录" Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/Ext/Site.Master"
    CodeBehind="PaymentInvoiceList.aspx.cs" Inherits="Aim.Examining.Web.PaymentInvoiceList" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            store = new Ext.ux.data.AimJsonStore({
                ...
                data: myData,
                fields: [
			    { name: 'Id' }, { name: 'Number' }, { name: 'CorrespondState' }, { name: 'CorrespondInvoice' }, { name: 'Name' },
			    { name: 'Money' }, { name: 'Remark' }, { name: 'CreateTime' }, { name: 'CId' }, { name: 'CName' }, { name: 'PayType' },
			    { name: 'ReceivablesTime' }, { name: 'CollectionType' }, { name: 'CorrespondAmount' }, { name: 'MagUser' }
			    ],
            ...
            schBar = new Ext.ux.AimSchPanel({
                ...
                collapsed: false,
                items: [
                { fieldLabel: '收款方式', schopts: { qryopts: "{ mode: 'Like', field: 'PayType' }"} },
                { fieldLabel: '客户名称', schopts: { qryopts: "{ mode: 'Like', field: 'CName' }"} },
                { fieldLabel: '负责人', schopts: { qryopts: "{ mode: 'Like', field: 'MagUser' }"} },
                { fieldLabel: '发票号码', schopts: { qryopts: "{ mode: 'Like', field: 'CorrespondInvoice' }"} },
            ...
            tlBar = new Ext.ux.AimToolbar({
                ...
                { text: '撤销对应',
                    ...
                    handler: function () {
                        ...
                        $.ajaxExec("AutoCorrespond", { ids: ids }, function (rtn) {
                            store.reload();
                        })
                    }
                }, '-',
            ...
            grid = new Ext.ux.grid.AimGridPanel({
                ...
                columns: [
                    ...
                    { dataIndex: 'MagUser', header: '负责人', width: 70, sortable: true },
					...
					{ id: 'CorrespondAmount', dataIndex: 'CorrespondAmount', header: '已对应金额', width: 100, sortable: true, summaryType: 'sum', renderer: RowRender,
					    summaryRenderer: function (v, params, data) { return AmountFormat(Math.round(v * 100) / 100); }
					},
					{ id: 'CorrespondState', dataIndex: 'CorrespondState', header: '对应状态', sortable: true, width: 80 },
					{ id: 'CorrespondInvoice', dataIndex: 'CorrespondInvoice', header: '对应发票号及销账金额', sortable: true, width: 160, renderer: RowRender },
					{ id: 'PayType', dataIndex: 'PayType', header: '收款方式', width: 80, sortable: true },
                    { id: 'Name', dataIndex: 'Name', header: '销账类型', width: 80, sortable: true },
                    { id: 'CollectionType', dataIndex: 'CollectionType', header: '收款类型', width: 80, sortable: true }
                    ],
                bbar: pgBar,
                tbar: titPanel,
