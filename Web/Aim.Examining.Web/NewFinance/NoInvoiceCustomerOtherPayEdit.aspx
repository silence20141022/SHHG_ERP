<%@ Page Title="其他收款" Language="C#" MasterPageFile="~/Masters/Ext/formpage.Master"
    AutoEventWireup="true" CodeBehind="NoInvoiceCustomerOtherPayEdit.aspx.cs" Inherits="Aim.Examining.Web.NoInvoiceCustomerOtherPayEdit" %>
            ...
            if ($("#Name").val() == "自动销账") {
                $.ajaxExec("AutoCorrespond", { CId: $("#CId").val(), PayAmount: $("#Money").val() }, function(rtn) {
                    if (rtn.data.Result == "T") {
                        ...
                        AimDlg.show("当前客户的应收款金额小于本次付款金额，不能自动对应,请选择手动销账！");
                        return;
                    }
                })
            }
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyHolder" runat="server">
    ...
    <fieldset>
        ...
        <table class="aim-ui-table-edit" style="border: none" width="100%">
            ...
            <tr>
                <td class="aim-ui-td-caption" id="billno">
                    收据号码
                </td>
                <td>
                ...
                <td class="aim-ui-td-data">
                    <input id="CollectionType" name="CollectionType" readonly="readonly" />
                </td>
            </tr>
            <tr>
                <td class="aim-ui-td-caption">
