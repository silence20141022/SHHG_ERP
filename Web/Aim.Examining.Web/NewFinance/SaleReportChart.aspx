<%@ Page Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    Title="" CodeBehind="SaleReportChart.aspx.cs" Inherits="Aim.Examining.Web.SaleReportChart" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function CreateChart(myData) {
            ...
            var jsondata = { chart: { decimalPrecision: '1', caption: "",formatNumberScale: '0',placeValuesInside: '0',
