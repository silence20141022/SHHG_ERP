<%@ Page Title="角色分类" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true" CodeBehind="RolCatalog.aspx.cs" Inherits="Aim.Portal.Web.CommonPages.RolCatalog" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            grid.getSelectionModel().on('rowselect', function(sm, rowIdx, r) {
                if (parent.AimSetCatalog) {
                    parent.AimSetCatalog(selCombo.getValue(), { cid: r.id });
                }
            });
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyHolder" runat="server">
    <div id="header" style="display:none;"><h1>角色分类</h1></div>
</asp:Content>
