<%@ Page Title="组织角色选择" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true" CodeBehind="FrmGroupSelView.aspx.cs" Inherits="Aim.Portal.Web.CommonPages.FrmGroupSelView" %>
    ...
    function setPgUI() {
        ...
        tlBar = new Ext.ux.AimToolbar({
            ...
            AimSelGrid = new Ext.ux.grid.AimGridPanel({
                ...
                region: 'center',
                columns: [
                    { id: 'GroupID', header: '标识', dataIndex: 'GroupID', hidden: true },
