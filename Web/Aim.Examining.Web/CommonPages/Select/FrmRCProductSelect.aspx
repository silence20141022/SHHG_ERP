<%@ Page Title="退换货商品选择" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master"
    AutoEventWireup="true" CodeBehind="FrmRCProductSelect.aspx.cs" Inherits="Aim.Examining.Web.CommonPages.Select.FrmRCProductSelect" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            store = new Ext.ux.data.AimJsonStore({
			    ...
			    options.data.onumber = getQueryString("onumber");
			}
			}
            });
            ...
            var buttonPanel = new Ext.form.FormPanel({
                ...
                grid = new Ext.ux.grid.AimGridPanel({
                    ...
                    AimSelCheckModel,
					{ id: 'Code', dataIndex: 'Code', header: '规格型号', renderer: ExtGridpperCase, width: 120, sortable: true },
					{ id: 'Name', dataIndex: 'Name', header: '商品名称', width: 110, sortable: true },
					{ id: 'Count', dataIndex: 'Count', header: '销售数量', width: 80, sortable: true },
					{ id: 'Guids', dataIndex: 'Guids', header: '唯一编号', width: 80, sortable: true },
