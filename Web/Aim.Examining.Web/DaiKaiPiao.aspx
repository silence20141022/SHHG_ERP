<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DaiKaiPiao.aspx.cs" Inherits="Aim.Examining.Web.DaiKaiPiao" %>
    ...
    <script type="text/javascript">
        ...
        Ext.onReady(function () {
            store = Ext.create('Ext.data.JsonStore', {
                fields: ['Id', 'Number', 'CName', 'TotalMoney', 'InvoiceState', 'Salesman', 'CreateTime'],
                proxy: {
                    url: 'DaiKaiPiao.aspx?action=load',
                    type: 'ajax',
                    reader: {
                        type: 'json',
                        root: 'rows',
            ...
            var grid = Ext.create('Ext.grid.Panel', {
                ...
                { dataIndex: 'Number', header: '销售单号', width: 110 },
                { dataIndex: 'CName', header: '客户名称', width: 240 },
				{ dataIndex: 'TotalMoney', header: '金额', width: 80, xtype: 'numbercolumn', format: '0,000' },
                { dataIndex: 'InvoiceState', header: '发票状态', width: 100 },
			    { dataIndex: 'Salesman', header: '销售负责人 ', width: 60 },
				{ dataIndex: 'CreateTime', header: '下单时间 ', width: 120 }
               ],
                bbar: pagebar
                //                plugins: [{
                //                    ptype: 'rowexpander',
