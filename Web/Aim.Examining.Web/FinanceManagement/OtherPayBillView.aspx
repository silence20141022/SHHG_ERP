<%@ Page Title="其他付款" Language="C#" MasterPageFile="~/Masters/Ext/formpage.master"
    AutoEventWireup="true" CodeBehind="OtherPayBillView.aspx.cs" Inherits="Aim.Examining.Web.FinanceManagement.OtherPayBillView" %>
        ...
        <table class="aim-ui-table-edit">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="aim-ui-td-data" colspan="3">
                        <textarea id="Remark" name="Remark" style="width: 74%; height: 45px"></textarea>
                    </td>
                </tr>
            </tbody>
        </table>
