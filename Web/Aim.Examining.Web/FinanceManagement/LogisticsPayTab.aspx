<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="LogisticsPayTab.aspx.cs" Inherits="Aim.Examining.Web.FinanceManagement.LogisticsPayTab" %>
        ...
        function setPgUI() {
            ...
            var viewport = new Ext.ux.AimViewport({
                ...
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "LogisticsList.aspx?Index=0";
                }
            }
            function handleActivate(tab) {
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "LogisticsList.aspx?Index=" + tabpanel.activeTab.tooltip;
                }
            }
    </script>
