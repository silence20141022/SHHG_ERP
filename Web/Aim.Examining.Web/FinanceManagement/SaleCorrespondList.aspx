<%@ Page Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="SaleCorrespondList.aspx.cs" Inherits="Aim.Examining.Web.FinanceManagement.SaleCorrespondList" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            store = new Ext.ux.data.AimJsonStore({
                ...
                data: myData,
                fields: [
			    { name: 'Id' }, { name: 'DeliveryOrderId' }, { name: 'CustomerId' }, { name: 'CustomerName' },
			    { name: 'InWarehouseId' }, { name: 'SupplierId' }, { name: 'SupplierName' }, { name: 'Amount' },
			    { name: 'InvoiceNo' }, { name: 'InvoiceAmount' }, { name: 'BillType' }, { name: 'AmountType' },
