<%@ Page Language="C#" MasterPageFile="~/Masters/Ext/formpage.Master" AutoEventWireup="true"
    CodeBehind="WarehouseExchangeEdit.aspx.cs" Inherits="Aim.Examining.Web.StockManagement.WarehouseExchangeEdit" %>
    ...
    <script type="text/javascript">
        ...
        function SuccessSubmit() {
            if (store.getCount() > 0) {
                ...
                if ($("#FromWarehouseId").val() == $("#ToWarehouseId").val()) {
                    AimDlg.show("调拨不能在同一个仓库间进行！");
                    return;
                }
                $.each(recs, function() {
                    if (this.get("ExchangeQuantity") > this.get("StockQuantity")) {
                        allow = false;
                        return false;
                    }
                })
        ...
        function InitEditTable() {
            ...
            var cm = new Ext.grid.ColumnModel({
                ...
                { id: 'ExchangeQuantity', dataIndex: 'ExchangeQuantity', header: '<label style="color:red;">调拨数量</label>', width: 60,
                    editor: { xtype: 'numberfield', minValue: 1, decimalPrecision: 0 }
                },
                { id: 'StockQuantity', header: '库存数量', dataIndex: 'StockQuantity', width: 70, resizable: true }
		        ]
            });
        ...
        <table class="aim-ui-table-edit">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="aim-ui-td-data">
                        <input aimctrl='popup' id="FromWarehouseName" name="FromWarehouseName" relateid="txtuserid"
                            class="validate[required]" style="width: 152px;" popurl="/CommonPages/Select/WarehouseSelect.aspx"
                            popparam="FromWarehouseId:Id;FromWarehouseName:Name" popstyle="width=800,height=550" />
                        <input id="FromWarehouseId" name="FromWarehouseId" type="hidden" />
                    </td>
                </tr>
                <tr>
                    <td class="aim-ui-td-caption">
                    ...
                    <td class="aim-ui-td-data">
                        <input aimctrl='popup' id="ToWarehouseName" name="ToWarehouseName" relateid="txtuserid"
                            class="validate[required]" style="width: 152px;" popurl="/CommonPages/Select/WarehouseSelect.aspx"
                            popparam="ToWarehouseId:Id;ToWarehouseName:Name" popstyle="width=800,height=550" />
                        <input id="ToWarehouseId" name="ToWarehouseId" type="hidden" />
                    </td>
                    <td class="aim-ui-td-caption">
                    </td>
                    <td class="aim-ui-td-data">
