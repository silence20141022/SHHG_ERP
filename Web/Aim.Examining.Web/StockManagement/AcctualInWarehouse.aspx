    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            var cm = new Ext.grid.ColumnModel({
                ...
                { id: 'Remark', dataIndex: 'Remark', header: '<label style="color:red;">备注</label>', width: 90, editor: { xtype: 'textarea' },
                    renderer: RowRender}]
                });
                grid = new Ext.ux.grid.AimEditorGridPanel({
                    ...
                    listeners: { "beforeedit": function(e) { (Ext.getCmp("acctual")).setMaxValue(e.record.get("NoIn")); }
                    }
                });
                //很重要的方法。让部分编辑项有效。无效
