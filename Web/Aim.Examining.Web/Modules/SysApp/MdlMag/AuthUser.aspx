<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="AuthUser.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.MdlMag.AuthUser" %>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        var Role = $.getQueryString({ "ID": "Type" });
        ...
        function setPgUI() {
            ...
            usrGrid = new Ext.ux.grid.AimGridPanel({
                id: 'usrPanel',
                store: usrStore,
                region: 'west',
                split: true,
            ...
            usrGrid.getSelectionModel().on('rowselect', function(sm, rowIdx, r) {
                frameContent.location.href = "AuthTree.aspx?type=user&op=r&id=" + r.data.UserID + "&Role="+Role;
            });
