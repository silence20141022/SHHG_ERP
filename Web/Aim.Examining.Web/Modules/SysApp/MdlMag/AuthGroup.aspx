<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true" CodeBehind="AuthGroup.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.MdlMag.AuthGroup" %>
            ...
            var tlBar = new Ext.Toolbar({
                ...
                grid.getSelectionModel().on('rowselect', function(sm, rowIdx, r) {
                    if (r.json.Type != "GType") {
                        frameContent.location.href = "AuthTree.aspx?type=group&op=r&id=" + r.json.GroupID;
                    }
                });
