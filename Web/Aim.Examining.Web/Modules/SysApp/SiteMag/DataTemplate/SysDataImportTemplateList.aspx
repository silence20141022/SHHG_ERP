...
<%@ Page Title="数据模版" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true" CodeBehind="SysDataImportTemplateList.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.SiteMag.SysDataImportTemplateList" %>

<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadHolder" runat="server">

<script type="text/javascript">
    var EditWinStyle = CenterWin("width=650,height=300,scrollbars=yes");
    var EditPageUrl = "SysDataImportTemplateEdit.aspx";
    ...
    function setPgUI() {
        ...
        myData = {
            ...
            records: AimState["SysDataImportTemplateList"] || []
        };

        // 表格数据源
        store = new Ext.ux.data.AimJsonStore({
            dsname: 'SysDataImportTemplateList',
            idProperty: 'DataImportTemplateID',
            data: myData,
            fields: [
        ...
        tlBar = new Ext.ux.AimToolbar({
            items: [{
                ...
                menu: [{ text: '导入数据', iconCls: 'aim-icon-db_import', handler: function() {
                    var recs = grid.getSelectionModel().getSelections();
                    if (!recs || recs.length <= 0) {
                        AimDlg.show("请先选择要导入数据的模版！");
                        return;
                    }

                    OpenImportWin(recs[0].data.Code);
                } }]
                }, '->', { text: '查询:' },
                ...
                grid = new Ext.ux.grid.AimGridPanel({
                    ...
                    columns: [
                    { id: 'DataImportTemplateID', header: '标识', dataIndex: 'DataImportTemplateID', hidden: true },
