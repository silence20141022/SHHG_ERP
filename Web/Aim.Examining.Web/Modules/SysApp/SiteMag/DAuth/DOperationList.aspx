...
<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true" CodeBehind="DOperationList.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.SiteMag.DOperationList" %>
...
<script type="text/javascript">
    ...
    function setPgUI() {
        ...
        myData = {
            ...
            records: AimState["DOperationList"] || []
        };

        // 表格数据源
        store = new Ext.ux.data.AimJsonStore({
            dsname: 'DOperationList',
            idProperty: 'DynamicOperationID',
            data: myData,
            fields: [
			{ name: 'DynamicOperationID' },
			{ name: 'Catalog' },
			{ name: 'Name' },
			{ name: 'Code' },
			{ name: 'IsDeafult' },
        ...
        schBar = new Ext.ux.AimSchPanel({
            ...
            tlBar = new Ext.ux.AimToolbar({
                items: [{
                    ...
                    handler: function() {
                        openEditWin("DOperationEdit.aspx", "c");
                    }
                }, {
                    text: '修改',
                    iconCls: 'aim-icon-edit',
                    handler: function() {
                        openEditWin("DOperationEdit.aspx", "u");
                    }
                }, {
                    text: '删除',
                ...
                grid = new Ext.ux.grid.AimGridPanel({
                    ...
                    monitorResize: true,
                    columns: [
                    { id: 'DynamicOperationID', header: '标识', dataIndex: 'DynamicOperationID', hidden: true },
                    new Ext.ux.grid.AimRowNumberer(),
                    new Ext.ux.grid.AimCheckboxSelectionModel(),
					{ id: 'Catalog', header: 'Catalog', width: 100,  sortable: true, dataIndex: 'Catalog' },
					...
					{ id: 'IsDeafult', header: 'IsDeafult', width: 100,  sortable: true, dataIndex: 'IsDeafult' },
					{ id: 'Tag', header: 'Tag', width: 100,  sortable: true, dataIndex: 'Tag' },
					{ id: 'SortIndex', header: 'SortIndex', width: 100,  sortable: true, dataIndex: 'SortIndex' },
            ...
            function linkRender(val, p, rec) {
                ...
                switch (this.dataIndex) {
                    case "Name":
                        rtn = "<a class='aim-ui-link' onclick='openEditWin(\"DOperationEdit.aspx?id=" + rec.id + "\")'>" + val + "</a>";
                        break;
                }
            ...
            function batchOperate(action, recs, params, url) {
                ...
                if (recs != null) {
                    jQuery.each(recs, function() {
                        idList.push(this.json["DynamicOperationID"]);
                    })
                }
