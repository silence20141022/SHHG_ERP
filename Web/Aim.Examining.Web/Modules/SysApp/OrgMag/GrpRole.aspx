<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true" CodeBehind="GrpRole.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.OrgMag.GrpRole" %>
            ...
            var tlBar = new Ext.Toolbar({
                ...
                grid.getSelectionModel().on('rowselect', function(sm, rowIdx, r) {
                    if (r.json.Type != "GType") {
                        frameContent.location.href = "RolTree.aspx?type=group&op=r&id=" + r.json.GroupID;
                    }
                });
