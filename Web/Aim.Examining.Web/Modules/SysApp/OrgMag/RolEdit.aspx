<%@ Page Title="角色编辑" Language="C#" MasterPageFile="~/Masters/Ext/formpage.master" AutoEventWireup="true" CodeBehind="RolEdit.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.OrgMag.RolEdit" %>
...
<script type="text/javascript">
    ...
    function setPgUI() {
        ...
        roleTypeField = new Ext.ux.form.AimComboBox({
            fieldLabel: '角色类型',
            name: 'Type',
            allowBlank: false,
            anchor: '75%',
        ...
        form = new Ext.ux.form.AimFormPanel({
            ...
            items: [{
                ...
                allowBlank: false,
                anchor: '75%'
            }, roleTypeField, new Ext.form.NumberField({
                fieldLabel: '排序号',
                name: 'SortIndex',
                anchor: '75%'
            }), {
                ...
                maxLength: 500,
                xtype: 'textarea',
                anchor: '100% -133'  // anchor width by percentage and height by raw adjustment
}],
            ...
            switch (op) {
                case "c":
                    action = "create";
                    var rolType = $.getQueryString({ ID: "type" });
                    if (rolType || rolType === 0) {
                        roleTypeField.setValue(rolType);
                        roleTypeField.setReadOnly(true);
                    }
                    break;
                case "cs":
                    action = "createsub";
