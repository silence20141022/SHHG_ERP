...
<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true" CodeBehind="SysParameterList.aspx.cs" Inherits="Aim.Portal.Web.Modules.SysApp.SiteMag.SysParameterList" %>
...
<script type="text/javascript">
    ...
    var EditPageUrl = "SysParameterEdit.aspx";
    ...
    function setPgUI() {
        ...
        myData = {
            ...
            records: AimState["SysParameterList"] || []
        };

        // 表格数据源
        store = new Ext.ux.data.AimJsonStore({
            dsname: 'SysParameterList',
        ...
        tlBar = new Ext.ux.AimToolbar({
            items: [{
                ...
                grid = new Ext.ux.grid.AimGridPanel({
					...
					{ id: 'Type', header: '值类型', width: 100, enumdata: DataTypeEnum, sortable: true, dataIndex: 'Type' },
