<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShouJuYingShou.aspx.cs"
    Inherits="Aim.Examining.Web.ShouJuYingShou" %>
    ...
    <script type="text/javascript">
        ...
        Ext.onReady(function () {
            store = Ext.create('Ext.data.JsonStore', {
                ...
                proxy: {
                    url: 'ShouJuYingShou.aspx?action=load',
                    type: 'ajax',
                    reader: {
                        type: 'json',
                        root: 'rows',
            ...
            var grid = Ext.create('Ext.grid.Panel', {
			    ...
			    { dataIndex: 'Salesman', header: '销售负责人 ', width: 70 },
