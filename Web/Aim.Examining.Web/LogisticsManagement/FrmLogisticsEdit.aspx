<%@ Page Title="物流信息" Language="C#" MasterPageFile="~/Masters/Ext/formpage.master"
    AutoEventWireup="true" CodeBehind="FrmLogisticsEdit.aspx.cs" Inherits="Aim.Examining.Web.LogisticsManagement.FrmLogisticsEdit" %>
        ...
        <table class="aim-ui-table-edit">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="aim-ui-td-data">
                        <input id="Number" name="Number" class="validate[required]length[7,7]" />
                    </td>
                    <td class="aim-ui-td-caption">
                        客户
                    </td>
                    <td class="aim-ui-td-data">
                        <input id="CustomerName" name="CustomerName" disabled="disabled" />
                ...
                <tr>
                    ...
                    <td class="aim-ui-td-data">
                        <input id="SendDate" name="SendDate" aimctrl="date" class="validate[required]" />
                    </td>
                    <td class="aim-ui-td-caption">
                    </td>
                    <td class="aim-ui-td-data">
