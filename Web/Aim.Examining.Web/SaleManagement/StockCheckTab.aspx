<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Ext/Site.Master" AutoEventWireup="true"
    CodeBehind="StockCheckTab.aspx.cs" Inherits="Aim.Examining.Web.SaleManagement.StockCheckTab" %>
        ...
        function setPgUI() {
            ...
            var viewport = new Ext.ux.AimViewport({
                ...
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "StockCheckList.aspx?Index=0";
                }
            }
            function handleActivate(tab) {
                if (document.getElementById("frameContent")) {
                    frameContent.location.href = "StockCheckList.aspx?Index=" + tabpanel.activeTab.tooltip;
                }
            }
    </script>
