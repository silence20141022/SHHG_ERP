<%@ Page Title="员工工资详细" Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/Ext/Site.Master"
    CodeBehind="FrmUserWageDetail.aspx.cs" Inherits="Aim.Examining.Web.FrmUserWageDetail" %>
        ...
        function setPgUI() {
            ...
            tlBar = new Ext.ux.AimToolbar({
                items: [{
                    ...
                    handler: function() {
                        jQuery.ajaxExec('openwage', {}, onExecuted);
                    }
                }, {
                    text: '删除',
                ...
                grid = new Ext.ux.grid.AimEditorGridPanel({
					...
					{ id: 'Stage', dataIndex: 'Stage', header: '批次', width: 120, sortable: true },
