<%@ Page Title="请假申请" Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/Ext/Site.Master"
    CodeBehind="FrmLeaveApp.aspx.cs" Inherits="Aim.Examining.Web.FrmLeaveApp" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            schBar = new Ext.ux.AimSchPanel({
                ...
                collapsed: false,
                items: [
                { fieldLabel: '请假人', id: 'LeaveUser', schopts: { qryopts: "{ mode: 'Like', field: 'LeaveUser' }"}}]
            });
            ...
            tlBar = new Ext.ux.AimToolbar({
                ...
                grid = new Ext.ux.grid.AimGridPanel({
					...
					{ id: 'LeaveUser', dataIndex: 'LeaveUser', header: '请假人', width: 100, sortable: true },
