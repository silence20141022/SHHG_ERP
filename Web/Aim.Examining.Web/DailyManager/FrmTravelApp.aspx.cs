...
{
    public partial class FrmTravelApp : ExamListPage
    {
        ...
        public void StartFlow()
        {
            ...
            //启动流程
            //表单路径,后面加上参数传入
            string formUrl = "/DailyManager/FrmTravelAppWFView.aspx?op=u&id=" + id;
            Guid guid = Aim.WorkFlow.WorkFlow.StartWorkFlow(id, formUrl, "出差申请(" + pb.LeaveUser + ")", code, this.UserInfo.UserID, this.UserInfo.Name);
        ...
        private void DoSelect()
        {
            ...
            string sql = @"select * from " + db + "..Travel" + where;
            this.PageState.Add("TravelList", GetPageData(sql, SearchCriterion));
        }
