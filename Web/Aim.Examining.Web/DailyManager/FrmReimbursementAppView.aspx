<%@ Page Title="出差报销申请" Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/Ext/Site.Master"
    CodeBehind="FrmReimbursementAppView.aspx.cs" Inherits="Aim.Examining.Web.FrmReimbursementAppView" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadHolder" runat="server">

    <script type="text/javascript">
        var EditWinStyle = CenterWin("width=800,height=600,scrollbars=yes");
        var EditPageUrl = "FrmReimbursementAppEdit.aspx";
        ...
        function setPgUI() {
            ...
            myData = {
                ...
                records: AimState["ReimbursementList"] || []
            };
            // 表格数据源
            store = new Ext.ux.data.AimJsonStore({
                dsname: 'ReimbursementList',
                idProperty: 'Id',
                data: myData,
                fields: [
			    { name: 'Id' },
