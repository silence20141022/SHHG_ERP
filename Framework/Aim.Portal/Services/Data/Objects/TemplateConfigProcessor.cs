...
namespace Aim.Portal.Data
{
    ...
    public abstract class TemplateConfigProcessor<T> : ITemplateConfigProcessor<T>
    {
        ...
        public virtual T GetObject(string configstr)
        {
            ...
            {
                string peeloffstr = StringHelper.PeerOff(configstr, WRAPPER_BEGIN, WRAPPER_END);

                string tconfigstr = StringHelper.Wrap(Preprocess(peeloffstr), WRAPPER_BEGIN_CHAR, WRAPPER_END_CHAR);
