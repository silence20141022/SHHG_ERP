...
{
	[ActiveRecord("SysEvent")]
	public partial class SysEvent : EntityBase<SysEvent> , INotifyPropertyChanged 	
	{
		...
		public string LoginName
		{
			...
			set
			{
				...
				{
					_loginName = value;
					NotifyPropertyChanged(SysEvent.Prop_LoginName);
				}
			}
		}
		...
		public string UserID
		{
			...
			set
			{
				...
				{
					_userID = value;
					NotifyPropertyChanged(SysEvent.Prop_UserID);
				}
			}
		}
		...
		public int? ApplicationID
		{
			...
			set
			{
				if (value != _applicationID)
				{
					...
					NotifyPropertyChanged(SysEvent.Prop_ApplicationID);
				}
			}
		}
		...
		public string ApplicationName
		{
			...
			set
			{
				if ((_applicationName == null) || (value == null) || (!value.Equals(_applicationName)))
				{
					...
					NotifyPropertyChanged(SysEvent.Prop_ApplicationName);
				}
			}
		}
		...
		public string ModuleID
		{
			...
			set
			{
				...
				{
					_moduleID = value;
					NotifyPropertyChanged(SysEvent.Prop_ModuleID);
				}
			}
		}
		...
		public string ModuleName
		{
			...
			set
			{
				...
				{
					_moduleName = value;
					NotifyPropertyChanged(SysEvent.Prop_ModuleName);
				}
			}
		}
		...
		public string AuthID
		{
			...
			set
			{
				...
				{
					_authID = value;
					NotifyPropertyChanged(SysEvent.Prop_AuthID);
				}
			}
		}
		...
		public string AuthName
		{
			...
			set
			{
				...
				{
					_authName = value;
					NotifyPropertyChanged(SysEvent.Prop_AuthName);
				}
			}
		}
		...
		public string Type
		{
			...
			set
			{
				...
				{
					_type = value;
					NotifyPropertyChanged(SysEvent.Prop_Type);
				}
			}
		}
		...
		public string IP
		{
			...
			set
			{
				...
				{
					_iP = value;
					NotifyPropertyChanged(SysEvent.Prop_IP);
				}
			}
		}
		...
		public string Record
		{
			...
			set
			{
				...
				{
					_record = value;
					NotifyPropertyChanged(SysEvent.Prop_Record);
				}
			}
		}
		...
		public DateTime? DateTime
		{
			...
			set
			{
				...
				{
					_dateTime = value;
					NotifyPropertyChanged(SysEvent.Prop_DateTime);
				}
			}
		}
