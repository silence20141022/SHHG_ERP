...
{
	[ActiveRecord("SysAuth")]
	public partial class SysAuth : EntityBase<SysAuth> , INotifyPropertyChanged 	
	{
		...
		[PrimaryKey("AuthID", Generator = PrimaryKeyType.Custom, CustomGenerator = typeof(AimIdentifierGenerator), Access = PropertyAccess.NosetterLowercaseUnderscore)]
		...
		public string Code
		{
			...
			set
			{
				...
				{
					_code = value;
					NotifyPropertyChanged(SysAuth.Prop_Code);
				}
			}
		}
		...
		public string Name
		{
			...
			set
			{
				...
				{
					_name = value;
					NotifyPropertyChanged(SysAuth.Prop_Name);
				}
			}
		}
		...
		public string ParentID
		{
			...
			set
			{
				...
				{
					_parentID = value;
					NotifyPropertyChanged(SysAuth.Prop_ParentID);
				}
			}
		}
		...
		public string Path
		{
			...
			set
			{
				...
				{
					_path = value;
					NotifyPropertyChanged(SysAuth.Prop_Path);
				}
			}
		}
		...
		public int? PathLevel
		{
			...
			set
			{
				...
				{
					_pathLevel = value;
					NotifyPropertyChanged(SysAuth.Prop_PathLevel);
				}
			}
		}
		...
		public int? Type
		{
			...
			set
			{
				...
				{
					_type = value;
					NotifyPropertyChanged(SysAuth.Prop_Type);
				}
			}
		}
		...
		public string ModuleID
		{
			...
			set
			{
				...
				{
					_moduleID = value;
					NotifyPropertyChanged(SysAuth.Prop_ModuleID);
				}
			}
		}
		...
		public string Data
		{
			...
			set
			{
				...
				{
					_data = value;
					NotifyPropertyChanged(SysAuth.Prop_Data);
				}
			}
		}
		...
		public string Description
		{
			...
			set
			{
				...
				{
					_description = value;
					NotifyPropertyChanged(SysAuth.Prop_Description);
				}
			}
		}
		...
		public int? SortIndex
		{
			...
			set
			{
				...
				{
					_sortIndex = value;
					NotifyPropertyChanged(SysAuth.Prop_SortIndex);
				}
			}
		}
		...
		public DateTime? LastModifiedDate
		{
			...
			set
			{
				if (value != _lastModifiedDate)
				{
					...
					NotifyPropertyChanged(SysAuth.Prop_LastModifiedDate);
				}
			}
		}
		...
		public DateTime? CreateDate
		{
			...
			set
			{
				...
				{
					_createDate = value;
					NotifyPropertyChanged(SysAuth.Prop_CreateDate);
				}
			}
		}
