...
{
	[ActiveRecord("SysParameterCatalog")]
	public partial class SysParameterCatalog : EditSensitiveTreeNodeEntityBase<SysParameterCatalog> , INotifyPropertyChanged 	
	{
		...
		[PrimaryKey("ParameterCatalogID", Generator = PrimaryKeyType.Custom, CustomGenerator = typeof(AimIdentifierGenerator), Access = PropertyAccess.NosetterLowercaseUnderscore)]
		...
		public string Code
		{
			...
			set
			{
				...
				{
					_code = value;
					NotifyPropertyChanged(SysParameterCatalog.Prop_Code);
				}
			}
		}
		...
		public string Name
		{
			...
			set
			{
				...
				{
					_name = value;
					NotifyPropertyChanged(SysParameterCatalog.Prop_Name);
				}
			}
		}
		...
		public override string EditStatus
		{
			...
			set
			{
				...
				{
					_editStatus = value;
					NotifyPropertyChanged(SysParameterCatalog.Prop_EditStatus);
				}
			}
		}
		...
		public string Description
		{
			...
			set
			{
				...
				{
					_description = value;
					NotifyPropertyChanged(SysParameterCatalog.Prop_Description);
				}
			}
		}
		...
		public string CreaterID
		{
			...
			set
			{
				...
				{
					_createrID = value;
					NotifyPropertyChanged(SysParameterCatalog.Prop_CreaterID);
				}
			}
		}
		...
		public string CreaterName
		{
			...
			set
			{
				...
				{
					_createrName = value;
					NotifyPropertyChanged(SysParameterCatalog.Prop_CreaterName);
				}
			}
		}
		...
		public DateTime? LastModifiedDate
		{
			...
			set
			{
				if (value != _lastModifiedDate)
				{
					...
					NotifyPropertyChanged(SysParameterCatalog.Prop_LastModifiedDate);
				}
			}
		}
		...
		public DateTime? CreatedDate
		{
			...
			set
			{
				...
				{
					_createdDate = value;
					NotifyPropertyChanged(SysParameterCatalog.Prop_CreatedDate);
				}
			}
		}
