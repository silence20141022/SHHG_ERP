...
{
	[ActiveRecord("SysParameter")]
	public partial class SysParameter : EntityBase<SysParameter> , INotifyPropertyChanged 	
	{
		...
		[PrimaryKey("ParameterID", Generator = PrimaryKeyType.Custom, CustomGenerator = typeof(AimIdentifierGenerator), Access = PropertyAccess.NosetterLowercaseUnderscore)]
		...
		public string Code
		{
			...
			set
			{
				...
				{
					_code = value;
					NotifyPropertyChanged(SysParameter.Prop_Code);
				}
			}
		}
		...
		public string Name
		{
			...
			set
			{
				...
				{
					_name = value;
					NotifyPropertyChanged(SysParameter.Prop_Name);
				}
			}
		}
		...
		public string CatalogID
		{
			...
			set
			{
				...
				{
					_catalogID = value;
					NotifyPropertyChanged(SysParameter.Prop_CatalogID);
				}
			}
		}

		[Property("Value", Access = PropertyAccess.NosetterCamelcaseUnderscore, Length = 150)]
		public string Value
		{
			get { return _value; }
			set
			{
				...
				{
					_value = value;
					NotifyPropertyChanged(SysParameter.Prop_Value);
				}
			}
		}
		...
		public string Type
		{
			...
			set
			{
				...
				{
					_type = value;
					NotifyPropertyChanged(SysParameter.Prop_Type);
				}
			}
		}
		...
		public string RegexStr
		{
			...
			set
			{
				...
				{
					_regexStr = value;
					NotifyPropertyChanged(SysParameter.Prop_RegexStr);
				}
			}
		}
		...
		public string EditStatus
		{
			...
			set
			{
				...
				{
					_editStatus = value;
					NotifyPropertyChanged(SysParameter.Prop_EditStatus);
				}
			}
		}
		...
		public int? SortIndex
		{
			...
			set
			{
				...
				{
					_sortIndex = value;
					NotifyPropertyChanged(SysParameter.Prop_SortIndex);
				}
			}
		}
		...
		public string Description
		{
			...
			set
			{
				...
				{
					_description = value;
					NotifyPropertyChanged(SysParameter.Prop_Description);
				}
			}
		}
		...
		public string CreaterID
		{
			...
			set
			{
				...
				{
					_createrID = value;
					NotifyPropertyChanged(SysParameter.Prop_CreaterID);
				}
			}
		}
		...
		public string CreaterName
		{
			...
			set
			{
				...
				{
					_createrName = value;
					NotifyPropertyChanged(SysParameter.Prop_CreaterName);
				}
			}
		}
		...
		public DateTime? LastModifiedDate
		{
			...
			set
			{
				if (value != _lastModifiedDate)
				{
					...
					NotifyPropertyChanged(SysParameter.Prop_LastModifiedDate);
				}
			}
		}
		...
		public DateTime? CreatedDate
		{
			...
			set
			{
				...
				{
					_createdDate = value;
					NotifyPropertyChanged(SysParameter.Prop_CreatedDate);
				}
			}
		}
