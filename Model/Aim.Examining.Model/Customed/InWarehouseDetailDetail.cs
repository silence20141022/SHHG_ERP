...
namespace Aim.Examining.Model
{
    ...
    /// </summary>
    [Serializable]
	public partial class InWarehouseDetailDetail
    {
        #region 成员变量
        ...
        {
			InWarehouseDetailDetail[] tents = InWarehouseDetailDetail.FindAll(Expression.In("Id", args));

			foreach (InWarehouseDetailDetail tent in tents)
			{
				tent.DoDelete();
			}
        }
