// Business class MessageDraft generated from MessageDraft
// Creator: Ray
...
{
	[ActiveRecord("MessageDraft")]
	public partial class MessageDraft : ExamModelBase<MessageDraft>
	{
		...
		public string Title
		{
			...
			set
			{
				if ((_title == null) || (value == null) || (!value.Equals(_title)))
				{
					...
					_title = value;
					RaisePropertyChanged(MessageDraft.Prop_Title, oldValue, value);
				}
			}
		...
		public string Content
		{
			...
			set
			{
				if ((_content == null) || (value == null) || (!value.Equals(_content)))
				{
					...
					_content = value;
					RaisePropertyChanged(MessageDraft.Prop_Content, oldValue, value);
				}
			}
		...
		public string Importance
		{
			...
			set
			{
				if ((_importance == null) || (value == null) || (!value.Equals(_importance)))
				{
					...
					_importance = value;
					RaisePropertyChanged(MessageDraft.Prop_Importance, oldValue, value);
				}
			}
		...
		public string Typeid
		{
			...
			set
			{
				if ((_typeid == null) || (value == null) || (!value.Equals(_typeid)))
				{
					...
					_typeid = value;
					RaisePropertyChanged(MessageDraft.Prop_Typeid, oldValue, value);
				}
			}
		...
		public string Type
		{
			...
			set
			{
				if ((_type == null) || (value == null) || (!value.Equals(_type)))
				{
					...
					_type = value;
					RaisePropertyChanged(MessageDraft.Prop_Type, oldValue, value);
				}
			}
		...
		public string ReleaseState
		{
			...
			set
			{
				if ((_releaseState == null) || (value == null) || (!value.Equals(_releaseState)))
				{
					...
					_releaseState = value;
					RaisePropertyChanged(MessageDraft.Prop_ReleaseState, oldValue, value);
				}
			}
		...
		public string ReleaseUser
		{
			...
			set
			{
				if ((_releaseUser == null) || (value == null) || (!value.Equals(_releaseUser)))
				{
					...
					_releaseUser = value;
					RaisePropertyChanged(MessageDraft.Prop_ReleaseUser, oldValue, value);
				}
			}
		...
		public string ReleaseTime
		{
			...
			set
			{
				if ((_releaseTime == null) || (value == null) || (!value.Equals(_releaseTime)))
				{
					...
					_releaseTime = value;
					RaisePropertyChanged(MessageDraft.Prop_ReleaseTime, oldValue, value);
				}
			}
		...
		public string ReadUser
		{
			...
			set
			{
				if ((_readUser == null) || (value == null) || (!value.Equals(_readUser)))
				{
					...
					_readUser = value;
					RaisePropertyChanged(MessageDraft.Prop_ReadUser, oldValue, value);
				}
			}
		...
		public int? ReadCount
		{
			...
			set
			{
				if (value != _readCount)
				{
					...
					_readCount = value;
					RaisePropertyChanged(MessageDraft.Prop_ReadCount, oldValue, value);
				}
			}
		...
		public string ReadState
		{
			...
			set
			{
				if ((_readState == null) || (value == null) || (!value.Equals(_readState)))
				{
					...
					_readState = value;
					RaisePropertyChanged(MessageDraft.Prop_ReadState, oldValue, value);
				}
			}
		...
		public string IsEnforcementUp
		{
			...
			set
			{
				if ((_isEnforcementUp == null) || (value == null) || (!value.Equals(_isEnforcementUp)))
				{
					...
					RaisePropertyChanged(MessageDraft.Prop_IsEnforcementUp, oldValue, value);
				}
			}
		...
		public string FileID
		{
			...
			set
			{
				if ((_fileID == null) || (value == null) || (!value.Equals(_fileID)))
				{
					...
					_fileID = value;
					RaisePropertyChanged(MessageDraft.Prop_FileID, oldValue, value);
				}
			}
		...
		public string CreateId
		{
			...
			set
			{
				if ((_createId == null) || (value == null) || (!value.Equals(_createId)))
				{
					...
					_createId = value;
					RaisePropertyChanged(MessageDraft.Prop_CreateId, oldValue, value);
				}
			}
		...
		public string CreateName
		{
			...
			set
			{
				if ((_createName == null) || (value == null) || (!value.Equals(_createName)))
				{
					...
					_createName = value;
					RaisePropertyChanged(MessageDraft.Prop_CreateName, oldValue, value);
				}
			}
		...
		public DateTime? CreateTime
		{
			...
			set
			{
				if (value != _createTime)
				{
					...
					_createTime = value;
					RaisePropertyChanged(MessageDraft.Prop_CreateTime, oldValue, value);
				}
			}
		...
		public string ReleaseId
		{
			...
			set
			{
				if ((_releaseId == null) || (value == null) || (!value.Equals(_releaseId)))
				{
					...
					_releaseId = value;
					RaisePropertyChanged(MessageDraft.Prop_ReleaseId, oldValue, value);
				}
			}
		...
		public DateTime? Period
		{
			...
			set
			{
				if (value != _period)
				{
					...
					_period = value;
					RaisePropertyChanged(MessageDraft.Prop_Period, oldValue, value);
				}
			}
		...
		public string ReleDepartment
		{
			...
			set
			{
				if ((_releDepartment == null) || (value == null) || (!value.Equals(_releDepartment)))
				{
					...
					RaisePropertyChanged(MessageDraft.Prop_ReleDepartment, oldValue, value);
				}
			}
		...
		public string ImgPath
		{
			...
			set
			{
				if ((_imgPath == null) || (value == null) || (!value.Equals(_imgPath)))
				{
					...
					_imgPath = value;
					RaisePropertyChanged(MessageDraft.Prop_ImgPath, oldValue, value);
				}
			}
		...
		public int? RemindDays
		{
			...
			set
			{
				if (value != _remindDays)
				{
					...
					_remindDays = value;
					RaisePropertyChanged(MessageDraft.Prop_RemindDays, oldValue, value);
				}
			}
